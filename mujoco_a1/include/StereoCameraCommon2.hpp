...
struct DepthCamera
{
  ...
  DepthCamera(int w, int h) : width(w), height(h), rgb(static_cast<unsigned char*>(malloc(h * w * 3))), depth((float*)(malloc(h * w * 1))), depthm((float*)(malloc(h * w * 1))), depth8(static_cast<unsigned char*>(malloc(h * w * 3))) {}
